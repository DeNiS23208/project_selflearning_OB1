...
SECRET_KEY = "django-insecure-h)oo#!xyvrvwvss@pb)728q7o2t()j1zw5d#92kjpd2kmdo$uv"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Платформа самообучения студентов",
    "DESCRIPTION": (
        "Учебная система, разработанная для студентов и преподавателей.\n\n"
        "**Основные функции:**\n"
        ...
        "- Публичный просмотр курсов для гостей\n"
    ),
    "VERSION": "1.0.0",
